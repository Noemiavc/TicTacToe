...
public class Partidas extends AppCompatActivity {
    ...
    int b1 = 5, b2 = 5,b3 = 5,
            b4 = 5, b5 = 5,b6 = 5,
            b7 = 5, b8 = 5,b9 = 5, xCount = 0, oCount = 0, i = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X")){
                    button1.setImageResource(R.drawable.lettercross);
                    b1 = 1;
                    i++;
                }
                else {
                    button1.setImageResource(R.drawable.lettercircle);
                    b1 = 0;
                    i++;
                }
                choosePlayer();
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X")){
                    button2.setImageResource(R.drawable.lettercross);
                    b2 = 1;
                    i++;
                }
                else {
                    button2.setImageResource(R.drawable.lettercircle);
                    b2 = 0;
                    i++;
                }
                choosePlayer();
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X")){
                    button3.setImageResource(R.drawable.lettercross);
                    b3 = 1;
                    i++;
                }
                else {
                    button3.setImageResource(R.drawable.lettercircle);
                    b3 = 0;
                    i++;
                }
                choosePlayer();
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X")){
                    button4.setImageResource(R.drawable.lettercross);
                    b4 = 1;
                    i++;
                }
                else {
                    button4.setImageResource(R.drawable.lettercircle);
                    b4 = 0;
                    i++;
                }
                choosePlayer();
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X")){
                    button5.setImageResource(R.drawable.lettercross);
                    b5 = 1;
                    i++;
                }
                else {
                    button5.setImageResource(R.drawable.lettercircle);
                    b5 = 0;
                    i++;
                }
                choosePlayer();
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X")){
                    button6.setImageResource(R.drawable.lettercross);
                    b6 = 1;
                    i++;
                }
                else {
                    button6.setImageResource(R.drawable.lettercircle);
                    b6 = 0;
                    i++;
                }
                choosePlayer();
        ...
        button7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X")){
                    button7.setImageResource(R.drawable.lettercross);
                    b2 = 1;
                    i++;
                }
                else {
                    button7.setImageResource(R.drawable.lettercircle);
                    b7 = 0;
                    i++;
                }
                choosePlayer();
        ...
        button8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X")){
                    button8.setImageResource(R.drawable.lettercross);
                    b8 = 1;
                    i++;
                }
                else {
                    button8.setImageResource(R.drawable.lettercircle);
                    b8 = 0;
                    i++;
                }
                choosePlayer();
        ...
        button9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(startGame.equals("X")){
                    button9.setImageResource(R.drawable.lettercross);
                    b9 = 1;
                    i++;
                }
                else {
                    button9.setImageResource(R.drawable.lettercircle);
                    b9 = 0;
                    i++;
                }
                choosePlayer();
